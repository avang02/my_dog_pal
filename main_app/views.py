...
def vet_search(request):
    ...
    if request.method == 'GET' and 'input' in request.GET:
        ...
        fields = 'formatted_address,name,business_status,rating'
        api_key = 'AIzaSyAUwpcXbJv7Jyb4_HJL7nYFVBQ7Xjv3CuA'
        user_latitude = request.GET.get('latitude')
        user_longitude = request.GET.get('longitude')

        url = f'https://maps.googleapis.com/maps/api/place/findplacefromtext/json?input={input_value}&inputtype={input_type}&fields={fields}&location={user_latitude},{user_longitude}&key={api_key}'
